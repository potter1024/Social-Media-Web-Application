...
<body>
	...
	<ul class="fixedElement">
		...
		?>
		 ...
		 <li>
			<a href="notifications.php?person_id=<?php echo $person_id ?>"><font color=#c4a747>Notifications</font></a>
		 </li>
...
$stmt = "SELECT discription from notifications where person_id='$id' order by date_added desc;";
...
if(!$count)
{
  ?>
  <br><br><br><br>
  <center><h1>IT'T EMPTY HERE</h1></center>
  <br><br><br><br>
  <?php
}
?>
