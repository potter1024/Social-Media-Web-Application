...
<body>
	...
	<ul class="fixedElement">
		...
		?>
		 ...
		 <li>
			<a href="people.php?person_id=<?php echo $person_id ?>"><font color=#c4a747>People</font></a>
		 </li>
...
$stmt = "SELECT name,person_id,gender FROM person where person_id != '$id' order by person_id desc";
