<?php
   ...
   exit();
       ...
       $stmt="insert into post(image,person_id,post_title,post_discription)
       values('$image','$person_id','$title','$discription');";
       $result=mysqli_query($mysqli,$stmt);
   
       $s1="select name from person where person_id='$person_id';";
       $ss1=mysqli_query($mysqli,$s1);
       $sss1=mysqli_fetch_row($ss1);
       $name=strtoupper($sss1[0]);
   
   
       $s="select person2_id from friendship where person1_id='$person_id';";
       $ss=mysqli_query($mysqli,$s);
       while($sss=mysqli_fetch_row($ss))
       {
         $friend_id=$sss[0];
         $disc=$name." has uploaded a new post";
         $s2="insert into notifications(person_id,discription) values('$friend_id','$disc');";
...
<html lang="en">
   ...
   <body>
      ...
      <ul>
         ...
         <li>
            <a href="check.php?person_id=<?php echo $person_id ?>">About</a>
         </li>
         <li>
      ...
      <h1 class="mb-30" align="center">POSTED SUCCESSFULLY</h1>
      <br><br><br><br><br><br><br><br><br>
      <div id="services">
      <div class="container">
         <br><br>
